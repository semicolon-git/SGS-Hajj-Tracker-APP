...
const en = {
  ...
  noFlight: "No flight",
  searchFlights: "Search flight number or airline",
  noFlightsMatch: "No flights match",
  hotel: "Hotel",
  address: "Address",
  pilgrim: "Name",
  company: "Company",
  ...
  groupAlreadyComplete: "Group already complete",
...
const ar: Dict = {
  ...
  noFlight: "بدون رحلة",
  searchFlights: "ابحث برقم الرحلة أو شركة الطيران",
  noFlightsMatch: "لا توجد رحلات مطابقة",
  hotel: "الفندق",
  address: "العنوان",
  pilgrim: "الاسم",
  company: "الشركة",
  ...
  groupAlreadyComplete: "المجموعة مكتملة بالفعل",
